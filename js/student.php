		...
		<div id="content">
			...
			<div class="container-fluid" id="content-area">
				...
				<ul class="quick" data-collapse="collapse">
					<li>
						<a href="#" id="ajouter_etudiant"><img src="img/icons/plus.png" alt="" /><span>Ajouter des Etudiants</span></a>
					</li>
                    <li>
						<a href="#" id="ajouter_etudiant"><img src="img/icons/reading.png" alt="" /><span>Listes des etudiants</span></a>
					</li>	
					</li>
				</ul>
			</div>
