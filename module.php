...
if (isset($_POST["ajouter"]))
{
	...
	$sql="insert into departement value(null,'".$nom_dep."','".$chef_dep."')";
	$req=$base->prepare($sql);
	$res=$req->execute();
	if($res)
...
if (isset($_POST["modifier"]))
{
	...
	$sql=" update departement set nom_dep='$nom_dep',chef_dep='$chef_dep' where id_dep=".$_GET['modifier'];
	$req=$base->prepare($sql);
	$res=$req->execute();
	if($res)
		header("location:departement.php");
		...
		<div id="content">
			...
			<div class="container-fluid" id="content-area">
					...
					<div class="span12">
						...
						{
							$id_d=$_GET["modifier"];
						$sql="select * from departement where id_admin=".$id_d;
						$req=$base->prepare($sql);
						$req->execute();
						...
						?>
						     ...
						     <td width='90'>
							 <a href='gestion_compte.php?modifier=".$departement->id_dep."'><button class='button button-basic-blue'>Modifier</button></a>
							 </td>
							  <td width='90'>
							 <a href='gestion_compte.php?supp=".$departement->id_dep."' onclick='return(confirm(\"voulez vous supprimer\"))'><button class='button button-basic-red'>Supprimer</button></a>
							 </td>
